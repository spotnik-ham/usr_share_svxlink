...
# YSF DMRQ Canada
  if {$cmd == "3032"} {
    dvswitchQSY $cmd "YSFN" "YSF" "38.110.97.161:42554" "Sc4fm"
    playSilence 100;
    playNumber 30;
    playSilence 100;
    playNumber 32;
...
# 108 Polaris
  if {$cmd == "108"} {
    puts "Executing external command"
    playMsg "Core" "online"
    exec nohup /etc/spotnik/restart.polaris &
    return 1
  }
...
# 109 Pg540
  if {$cmd == "109"} {
    puts "Executing external command"
    playMsg "Core" "online"
    exec nohup /etc/spotnik/restart.pg540 &
    return 1
  }
...
# 112 Emcom
 if {$cmd == "112"} {
    puts "Executing external command"
    playMsg "Core" "online"
    exec nohup /etc/spotnik/restart.emcom &
    return 1
  }
